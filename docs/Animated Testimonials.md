...
data	Array<Testimonial>	required	
An array of testimonial objects to display.
name	string	required	
Name of the person giving the testimonial. Used inside each data item.
image	string	required	
URL of the profile image. Used inside each data item.
description	string	required	
Testimonial message or feedback. Used inside each data item.
