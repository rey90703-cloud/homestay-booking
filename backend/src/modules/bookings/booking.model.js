...
const bookingSchema = new mongoose.Schema(
  {
    ...
    // Hold expiration for pending bookings (15 minutes hold)
    holdExpiresAt: {
      type: Date,
...
// Compound index for overlap detection - critical for performance
bookingSchema.index({ homestayId: 1, status: 1, checkInDate: 1, checkOutDate: 1 });
